                ...
                <div className="w-full flex items-start justify-items-start px-20 py-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 mt-10 items-center gap-12 lg:items-end lg:justify-center">
                        {blends.map((blend, index) => (
                            <div key={index} className={`card flex flex-col items-center justify-items-center ${blend.color} rounded-2xl shadow-lg p-6 transition-transform duration-200 hover:scale-105`}>
                                <Link href={blend.url}>
